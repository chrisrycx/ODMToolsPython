...
"""
This module is associated with the database connection form that pops up
at the start of the program. The values input are saved 
"""

#CC - Added code to get SQLite as option
...
class pnlDBConfig(clsDBConfig.clsDBConfiguration):
    def __init__(self, parent, service_manager, is_main=False):
        ...
        self.choices = {"Microsoft SQL Server": 'mssql', "MySQL": 'mysql', "PostgreSQL":"postgresql", "SQLite":"sqlite"}  #CC - Added SQLite
    ...
    def validateInput(self, conn_dict):
        """
        Takes input from form and checks if it has been filled out followed by
